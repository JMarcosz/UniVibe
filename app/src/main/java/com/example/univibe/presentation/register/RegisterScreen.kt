...
fun RegisterScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Scaffold(
            ...
            topBar = {
                ...
                Row(
                    ...
                    IconButton(
                        ...
                        modifier = Modifier
                            .size(40.dp)
                            .background(TextField, CircleShape).padding(top = 12.dp)// Botón atrás con fondo sutil
                    ) {
                        Icon(
            ...
            Column(
                ...
                UserAvatar(
                    ...
                    initial = uiState.firstName.take(1).ifEmpty { "U" },
                    size = 110.dp,
                    isEditable = true,
                    onEditClick = { viewModel.onEditPhotoClick() },
                    borderColor = BtnPrimary.copy(alpha = 0.1f),
                    borderWidth = 2.dp
                )
        ...
        // Modal de selección de foto - Fuera del Scaffold para que se renderice correctamente
        PhotoSelectionModal(
